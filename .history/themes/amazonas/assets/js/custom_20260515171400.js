...
$(document).ready(function(){   
   ...
   if (length_cat > 10){
    ...
    $('#menu-icon').on('click',function(){
        if ($(window).width() <= 767){
            ...
            if($(this).hasClass('closed'))
            {
                ...
                wrapper.stop(true,true).show().addClass('active');
            ...
            else
            {
                ...
                wrapper.stop(true,true).hide().removeClass('active');
            }   
         }     
    });
    ...
    $(document).on('click', '#mobile-categories-block .close_menu', function(){
        ...
        $('#mobile-categories-block').stop(true,true).hide().removeClass('active');
    });
