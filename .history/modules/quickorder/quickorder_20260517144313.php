...
class QuickOrder extends Module
{
    ...
    private function installConfiguration(): bool
    {
        ...
        return Configuration::updateValue(self::CONFIG_COD_MODULE, 'ps_cashondelivery');
    }
    ...
    /**
     * Hook header : supprimé au profit du chargement direct dans hookDisplayFooter.
     */
    public function hookDisplayHeader(array $params): void
    {
        // Assets gérés dans hookDisplayFooter pour garantir le chargement
    }
    ...
    public function hookDisplayProductActions(array $params): string
    {
        ...
        if (is_object($product)) {
            ...
            // Page produit : id_product / Quickview : id
