 ...
 *
 * Gestion :
 *  - Synchronisation produit + attributs (combinaisons) depuis la fiche produit
 *  - Validation client-side des champs du formulaire
 *  - Envoi AJAX et affichage des retours serveur
 *
 * Aucune dépendance externe – utilise l'API Fetch native et Bootstrap 4/5.
 * Compatible ES2020 / Browsers modernes (+ IE11 si besoin via Babel).
 */
...
(function () {
    ...
    const MODAL_ID   = '#quickOrderModal';
    const FORM_ID    = '#quickOrderForm';
    const ALERT_ID   = '#qo-alert';
    const SUBMIT_ID  = '#qo-submit';
    const BTN_CLASS  = '.quickorder-btn';
