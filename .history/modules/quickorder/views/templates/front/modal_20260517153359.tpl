        ...
        <div class="modal-content">
            ...
            <div class="modal-header quickorder-modal__header">
                ...
                <p class="quickorder-modal__subtitle">
                    {l s='Paiement à la livraison – Nous vous contacterons rapidement pour confirmer votre commande.' mod='quickorder'}
                </p>
                <button
                    type="button"
            ...
            <div class="modal-body">
                ...
                <div class="quickorder-product-summary alert alert-info" role="status" aria-live="polite">
                    <div><strong>{l s='Produit :' mod='quickorder'}</strong> <span id="qo-product-name"></span></div>
                    <div class="qo-summary-details" style="margin-top:6px; display:flex; gap:24px; flex-wrap:wrap;">
                        <span><strong>{l s='Prix :' mod='quickorder'}</strong> <span id="qo-product-price">—</span></span>
                        <span><strong>{l s='Quantité :' mod='quickorder'}</strong> <span id="qo-product-qty">1</span></span>
                        <span><strong>{l s='Total :' mod='quickorder'}</strong> <span id="qo-product-total">—</span></span>
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            maxlength="20"
                            required
                            placeholder="{l s='Ex : 00 000 000' mod='quickorder'}"
                            aria-required="true"
                        >
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5 form-group">
                            ...
                            <input
                                ...
                                maxlength="4"
                                required
                                placeholder="{l s='Ex : 4020' mod='quickorder'}"
                                aria-required="true"
                            >
                            <div class="invalid-feedback"></div>
                        </div>
