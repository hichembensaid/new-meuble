{**
 * Template modal - Commande Rapide
 * views/templates/front/modal.tpl
 *
 * Variables injectées depuis le hook :
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="qo-alert" class="alert d-none" role="alert" aria-live="assertive"></div>
            ...
            <div class="modal-footer quickorder-modal__footer">
                ...
                >
                    ...
                    <span class="qo-submit__loading d-none" aria-hidden="true">
