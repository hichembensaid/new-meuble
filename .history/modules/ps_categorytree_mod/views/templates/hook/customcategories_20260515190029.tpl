        ...
        {foreach from=$nodes item=node}
          ...
          <li {if isset($i) && $i > 10} class="hidden_product"{/if}>
                ...
                {if $depth===0}
                  ...
                  {if $node.children}
                    <button type="button" class="navbar-toggler collapse-icons" data-toggle="collapse" data-target="#customexCollapsingNavbar{$node.id|escape:'html':'UTF-8'}" aria-expanded="false">
