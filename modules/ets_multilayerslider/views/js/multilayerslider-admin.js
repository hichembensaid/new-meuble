...
function checkFormFields()
{
    if($('.mls_form select[name="layer_type"]').length > 0)
    {
        ...
        else if($('.mls_form select[name="layer_type"]').val()=='text_background')
        {
            ...
            $('.mls_form .row_box_radius,.mls_form .row_text_decoration,.mls_form .row_content_layer ,.mls_form .row_link,.mls_form .row_padding,.mls_form .row_font_size,.mls_form .row_text_color,.mls_form .row_font_weight,.mls_form .row_font_family,.mls_form .row_background_color,.mls_form .row_text_transform').show();
