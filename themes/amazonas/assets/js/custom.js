...
$(document).ready(function(){   
   ...
   if (length_cat > 10){
    ...
    /* ANCIEN CODE - DÉSACTIVÉ - Utilise maintenant mobile-menu-clean.tpl
    ...
    */
    ...
    $('.search-widget form input[type="text"]').on('focus', function(){
        if ($(window).width() <= 767)
        $(this).parent().addClass('form_focus');
    });
    $('.search-widget form input[type="text"]').on('blur', function(){
        if ($(window).width() <= 767)
